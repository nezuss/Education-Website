...
export default function AppRouter() { return <BrowserRouter><Routes><Route element={<AppShell />}>
    ...
    <Route path="/student" element={<StudentDashboardPage />} /><Route path="/student/courses" element={<MyCoursesPage />} /><Route path="/student/learning/:courseId" element={<LearningPage />} /><Route path="/student/lesson/:lessonId" element={<LearningPage />} /><Route path="/student/assignments/:assignmentId" element={<AssignmentPage />} /><Route path="/student/upload/:assignmentId" element={<UploadProjectPage />} /><Route path="/student/profile" element={<ProfilePage />} />
...
</Route><Route path="/login" element={<LoginPage />} /><Route path="/registration" element={<RegistrationPage />} /><Route path="/not-found" element={<NotFoundPage />} /><Route path="*" element={<Navigate to="/not-found" replace />} /></Routes></BrowserRouter>; }
